...
def build_env():
    ...
    # build charts
    for file in os.listdir("decision_transformer/training/Colab/datafiles"):
        if file.endswith(".pkl"):
            symbol = file.replace(".pkl", "")
            df_charts[symbol] = pd.read_pickle(os.path.join("decision_transformer/training/Colab/datafiles", file))
