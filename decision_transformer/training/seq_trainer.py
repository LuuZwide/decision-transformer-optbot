...
class SequenceTrainer(Trainer):
    ...
    def train_step(self):
        ...
        state_preds, action_preds, return_preds, _ = self.model.forward(
        ...
        return_target = rtg[:, 1:].reshape(-1)[attention_mask.reshape(-1) > 0]

        loss = self.loss_fn(
            state_preds, action_preds, return_preds,
            state_target, action_target, return_target,
        )
